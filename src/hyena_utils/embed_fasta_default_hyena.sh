...
MODEL_CFG="/oak/stanford/groups/horence/dcotter1/utility_files/hyena_models/default_hyena_hg38/hg38_256dim_config.yml"
MODEL_CKPT="/oak/stanford/groups/horence/dcotter1/utility_files/hyena_models/default_hyena_hg38/weights.ckpt"
