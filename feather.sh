...
x = feather.read_feather("results/260622-01-temnothorax-challenge/260622-01-temnothorax-challenge_hyena_top_variance_features_for_glmnet_filter1_noCluster_top20000_target1_k40_s40_normalized.feather")
m = pd.read_table("/scratch/users/jiamuyu/proj_botryllus/splash2/260621_01_tcurvispinsosus_challenge/metadata.tsv")
